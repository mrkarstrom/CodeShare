<script lang="ts">
	import { snippetStore, addSnippet } from '../stores/SnippetStore';
...
<div class="container mx-auto flex h-full items-center justify-center">
	<div class="grid min-w-full grid-cols-1 gap-4 md:min-w-[750px]">
		...
		<div class="space-y card rounded-md w-full p-4 text-token">
			...
			<label class="label" for="selection">
				...
				<select class="select rounded-lg" name="selection" bind:value={formData.language}>
